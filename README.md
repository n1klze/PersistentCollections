...
|----------------|------------------------------------------------|      
|Мельников Никита|Реализация персистентного ассоциативного массива|
|                |Покрытие тестами, настройка автодокументирования|
|                |undo-redo механизм                              |
|Андрей Силицкий |Реализация персистентного массива               |
...
**Для ассоциативного массива** реализуется path copying на базе Hash Array Mapped Trie (HAMT):
...
**Для двусвязного списка** реализуется full-chain copy.
